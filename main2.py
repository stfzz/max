...
class make_gui:
    def upload_files(self):
        ...
        uploaded_files = self.upldr.file_uploader(
            "Scegliere file Excel da caricare", accept_multiple_files=True
        )
        return uploaded_files

    def which_year(self):
        anno_riferimento = self.year.selectbox(
            "Anno riferimento", ("2020", "2021", "2022")
        )
    ...
    def cntnr(self):
        ...
        with f:
            ...
            # st.write(checks)
            submit = self.bttn.form_submit_button(
                "Iniziare elaborazione e controllo errori"
            )
